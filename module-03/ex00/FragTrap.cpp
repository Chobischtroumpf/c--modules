...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/05/02 16:33:28 by adorigo           #+#    #+#             */
/*   Updated: 2020/05/04 00:52:14 by adorigo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void FragTrap::takeDamage(unsigned int amount)
{
	...
	if (this->hitPoints < 0)
	{
		...
		std::cout
			<< "votre FR4G-TP n'a presque plus de vie" << std::endl;
}
...
void FragTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << "YOUR CL4P-TRAP WAS HEALED, YOU HEARD THAT ? I. WAS. HEALED." << std::endl;
}
